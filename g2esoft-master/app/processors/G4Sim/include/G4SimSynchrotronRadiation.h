...
#ifndef G4SimSynchrotronRadiation_h
#define G4SimSynchrotronRadiation_h 1
...
class G4SimSynchrotronRadiation : public G4VContinuousDiscreteProcess
{
public:

  explicit G4SimSynchrotronRadiation(const G4String& pName = "G4SimSynRad",
		         G4ProcessType type = fElectromagnetic);

  virtual ~G4SimSynchrotronRadiation();
...
private:
  ...
  G4SimSynchrotronRadiation & 
    operator=(const G4SimSynchrotronRadiation &right) = delete;
  G4SimSynchrotronRadiation(const G4SimSynchrotronRadiation&) = delete;
...
inline G4double 
G4SimSynchrotronRadiation::Chebyshev(G4double a, G4double b, const G4double c[],
				  G4int n, G4double x)
{
  G4double y;
...
#endif  // end of G4SimSynchrotronRadiation.hh
